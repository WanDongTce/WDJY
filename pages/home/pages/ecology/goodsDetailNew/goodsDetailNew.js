// pages/periphery/goodsDetailNew/goodsDetailNew.js
...
Page({
    ...
    network.POST({
      ...
      success: function (res) {
        ...
        if (res.data.code == 200) {
          ...
          wx.navigateTo({
            url: '/pages/home/pages/periphery/confirmOrder/confirmOrder?flag=1'
          })
        } else {
          wx.showToast({
            title: res.data.message
  ...
  toGift() {
    wx.navigateTo({
      url: '/pages/home/pages/periphery/gift/gift?id=' + id,
    })
  }
})